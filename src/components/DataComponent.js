            ...
            <div className="col-0 ">
                <div>
                    ...
                    <div className="col-12">
                        <h4 className="data-place">SECRETARÍA DE EXTENSIÓN</h4>
                        <hr />
                        <h5 className="data-info">Coordinación Comisión
                            sobre Discapacidad,
                    ...
                    <div className="col-12">
                        <h4 className="data-place">SECRETARÍA DE
                            BIENESTAR ESTUDIANTIL</h4>
                        <hr />
                    ...
                    <div className="col-12">
                        <h4 className="data-place">SECRETARÍA ACADÉMICA</h4>
                        <hr />
